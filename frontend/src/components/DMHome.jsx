...
import { Search, UserPlus, Inbox, Bookmark } from "lucide-react";
    ...
    <>
      <aside className="w-64 bg-cc-surface1 border-r border-cc-border flex flex-col shrink-0">
        ...
        <div className="px-2 pb-2">
          <button onClick={() => navigate("/app/me/bookmarks")} data-testid="dm-bookmarks-link" className="w-full flex items-center gap-3 px-2 py-2 hover:bg-cc-surface2 text-left transition-colors text-cc-subtext hover:text-cc-text">
